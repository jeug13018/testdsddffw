    ...
    <template v-else>
      ...
      <div class="p-4 bg-white dark:bg-gray-800 mt-2 shadow-sm rounded-md mb-5">
        ...
        <div class="text-gray-600 dark:text-gray-400 text-sm mt-3 flex items-start">
          ...
          <span>支付成功一般10分钟内到账，如超过30分钟未到账，请保留支付凭证，并复制订单编号，联系客服邮箱<span @click="openSupportEmail" class="text-blue-500 cursor-pointer underline">{{ supportEmail }}</span>处理</span>
        </div>
      </div>
      ...
      <DialogContent class="max-w-xs">
        ...
        <DialogFooter>
          ...
          <div class="text-center text-xs text-gray-500 dark:text-gray-400">
            如有支付问题，请联系客服邮箱<span @click="openSupportEmail" class="text-blue-500 cursor-pointer underline">{{ supportEmail }}</span>处理
          </div>
        </DialogFooter>
      </DialogContent>
    </Dialog>
